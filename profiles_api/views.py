...
class HelloViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        a_viewset = [
        'Uses actions (list, create, retrieve, update, partal_update)',
        'Automatically maps to URL using Routers'
        'Provides more functionality with lass code'
        ]
...
class UserProfileViewSet(viewsets.ModelViewSet):
    """ Handle creating and updating a profiles."""
...
class UserLoginApiView(ObtainAuthToken):
    ...
    reader_classes = api_settings.DEFAULT_RENDERER_CLASSES
